...
issues_url 'https://github.com/x103103/learn_chef_lamp/issues' if respond_to?(:issues_url)
source_url 'https://github.com/x103103/learn_chef_lamp' if respond_to?(:source_url)
supports 'ubuntu'
